...
from apps.usuarios.views import UserHome, HomeRepositorio, HomeSenales

urlpatterns = [

    url(r'^admin/', admin.site.urls),
    url(r'^usuarios/', include('apps.usuarios.urls', namespace="usuarios")),
    url(r'^senales/', include('apps.senales.urls', namespace="senales")),
    ...
    url(r'^homesenales/', login_required(HomeSenales), name="senales_home"),
    url(r'^homerepositorio/', login_required(HomeRepositorio), name="repositorio_home"),
]
